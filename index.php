...
<?php get_header();?>
      ...
      <ul class="index_top_pic">
        <div class="element first on">
          <li class="index_top_pic_img1 active">
            <img alt="画像1" src="<?php echo get_stylesheet_directory_uri(); ?>/img/img1.png" class="pc">
            <img alt="画像1" src="<?php echo get_stylesheet_directory_uri(); ?>/img/laura-chouette-x-xEeWUfgdY-unsplash.png" class="sp">
        ...
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/white-right.svg" class="white_right1 arrow_on right_on">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/white-left.svg" class="white_left1 arrow_on left_on">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-left.svg" class="black_left2">
        ...
        <div class="element second">
          <li class="index_top_pic_img2">
            ...
            <div class="index_top_pic_img2_text">
              <p class="index_top_pic_img2_text_new">New Arrival</p>
              <h1 class="index_top_pic_img2_text_title">floma original
              </h1>
              <a href="#" class="index_top_pic_img2_text_btn">詳しく</a>
            </div>
          </li>
        </div>
        ...
        <div class="element third">
          <li class="index_top_pic_img3">
            ...
            <div class="index_top_pic_img3_text">
              <p class="index_top_pic_img3_text_new">New Arrival</p>
              <h1 class="index_top_pic_img3_text_title">加湿でアロマを
              </h1>
              <a href="#" class="index_top_pic_img3_text_btn">詳しく</a>
            </div>
          </li>
        </div>
    ...
    <div class="index_news">
      ...
      <div class="index_news_important">
