...
?>
<?php get_header();?>
    <div class="smell_top pc">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/flower.png" class="smell_top_pic"></div>
      <h1 class="smell_top_title">香りを生み出す物語</h1>
    </div>
    <div class="smell_top sp">
    ...
    <div class="index_columns">
      <div class="index_columns_back smell">
        ...
        <a href="#" class="index_columns_btn">もっと見る</a>
