...
<footer>
      <div class="footer_pc">
        <ul class="footer_pc_menu">
          <li class="footer_pc_menu_item top">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black.svg" class="footer_pc_menu_item_pic">
        ...
        <div class="footer_pc_logo">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/title.svg" class="footer_pc_logo">
        </div>
        <p class="footer_pc_text">Copyright©floma Inc. All rights reserved</p>
        <div class="footer_pc_share">
          <div class="footer_pc_share_sns">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-twitter.svg" class="footer_pc_share_sns_t">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-facebook-f.svg" class="footer_pc_share_sns_f">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-instagram-1.svg" class="footer_pc_share_sns_i">
          </div>
      ...
      <div class="footer_sp">
        ...
        <div class="footer_sp_sns">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-twitter-1.svg" class="footer_sp_sns_icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-facebook-f-1.svg" class="footer_sp_sns_icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon awesome-instagram.svg" class="footer_sp_sns_icon">
        </div>
        <div class="footer_sp_border"></div>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/title.svg" class="footer_sp_logo">
      ...
      <div class="footer_mail">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Icon feather-mail-1.svg">
